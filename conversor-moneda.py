#Paso 1: Definir valor actual del Euro y Dolar con respecto al peso mexicano

tipo_cambio_eur_a_mxn = 23.70 #Este valor esta hardcodeado ya que es una ejercitacion. Deberia ir a buscar el valor a una BBDD o API
tipo_cambio_usd_a_mxn = 20.75 #Este valor esta hardcodeado ya que es una ejercitacion. Deberia ir a buscar el valor a una BBDD o API

#Paso 2: Solicitar el usuario el tipo de conversion (Euro a Mex o Dolar a Mex).
